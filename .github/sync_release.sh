...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Lynx48_MiSTer.git"
CORE_NAME=(Lynx48)
...
UPSTREAM_CORE_NAME=(Lynx48)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Lynx48.qpf)
COMPILATION_OUTPUT=(output_files/Lynx48.rbf)
